<template>
    <transition name="slide-fade">
        <div v-if="flash.success && flash.success != ''"
            ...
            <div class="flex p-4 justify-between items-center bg-green-600 rounded-lg">
                ...
                <div class="mx-3 text-lg font-medium text-white" v-html="flash.success"></div>
    ...
    <transition name="slide-fade">
        <div v-if="flash.info && flash.info != ''" class="absolute top-4 right-4 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
    ...
    <transition name="slide-fade">
        <div v-if="flash.warning && flash.warning != ''" class="absolute top-24 right-4 w-8/12 md:w-6/12 lg:w-3/12 z-[100]">
