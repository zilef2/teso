...
function ValidarString() {
    if(form.ingresos_o_egresos !== 'ingresos' && form.ingresos_o_egresos !== 'egresos'){
        return 'El ultimo campo de ser ingresos o egresos'
    }
    return ''
}
...
const create = () => {
    if (ValidarVacios()) {
        let validarGresos = ValidarString()
        if (validarGresos.localeCompare('') === 0) {
...
<template>
    <section class="space-y-6">
        <Modal :show="props.show" @close="emit('close')" max-width="xl3">
